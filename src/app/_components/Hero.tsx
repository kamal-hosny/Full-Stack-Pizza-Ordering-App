...
const Hero = () => {
  ...
  <section className="section-gap">
      <div className="container grid-cols-1 md:grid-cols-2">
      <div className="py-12">
        <h1 className="text-4xl font-semibold">Slice into Happiness</h1>
        <p className="text-accent my-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni
          corporis ab, quia accusamus, est labore repellat quam, hic alias
          dignissimos quas modi iste adipisci optio voluptatibus vero ducimus
          cumque dolorum.
        </p>
